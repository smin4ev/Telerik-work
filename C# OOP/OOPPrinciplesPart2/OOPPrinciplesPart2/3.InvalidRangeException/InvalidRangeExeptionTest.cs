...
namespace _3.InvalidRangeException // Решението е взаимствано от форума!!!
{
   //Define a class InvalidRangeException<T> that holds information about an error 
   //condition related to invalid range. It should hold error message 
   ...
   //InvalidRangeException<DateTime> by entering numbers in the range [1..100] and dates in the range [1.1.1980 … 31.12.2013].
    ...
    class InvalidRangeExeptionTest
    {
